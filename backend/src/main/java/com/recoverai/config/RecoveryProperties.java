...
public record RecoveryProperties(String storageMode, boolean publicWebhookOnly, Firebase firebase, Razorpay razorpay, Recovery recovery, Thresholds thresholds, String frontendUrl) {
