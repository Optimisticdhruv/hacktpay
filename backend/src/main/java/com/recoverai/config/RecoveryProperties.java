...
public record RecoveryProperties(String storageMode, boolean publicWebhookOnly, Firebase firebase, Razorpay razorpay, Recovery recovery, Thresholds thresholds, Ollama ollama, Security security, Detection detection, String frontendUrl) {
    ...
    public record Security(boolean authEnabled) {}
    public record Detection(boolean razorpayFailureEnabled) {}
}
